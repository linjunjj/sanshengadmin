<template >
  ...
  <!--列表-->
    <el-table :data="list" v-loading="listLoading" element-loading-text="拼命加载中" :height="tableHeight" border stripe fit
      ...
      <el-table-column align="center" min-width="150px" label="订单流水号" show-overflow-tooltip>
        <template scope="scope">
          <span class="link-type" @click="handleDetail(scope.row)">{{scope.row.orderCode}}</span>
        </template>
      </el-table-column>

      <el-table-column align="center" width="180px" label="商品名" prop="timestamp" sortable>
      </el-table-column>
      ...
      <el-table-column align="center" width="180px" label="联系方式" prop="timestamp" sortable>
      </el-table-column>
      <el-table-column align="center" width="180px" label="单价" prop="timestamp" sortable>
      </el-table-column>
      <el-table-column align="center" width="180px" label="数量" prop="timestamp" sortable>
      </el-table-column>
